...
function Rmanageequality() {
    ...
    if (!(game.global.challengeActive == "Exterminate" && getPageSetting('Rexterminateon') == true && getPageSetting('Rexterminateeq') == true && !game.global.mapsActive)) {
        if (fastimps.includes(getCurrentEnemy().name) || (game.global.mapsActive && getCurrentMapObject().location == "Void" && (getCurrentMapObject().name.includes('Deadly') || usingRealTimeOffline) )) {
