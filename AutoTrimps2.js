var ATversion='Staal v0.1',atscript=document.getElementById('AutoTrimps-script'),basepath='https://jeroenstalenburg.github.io/AutoTrimps/',modulepath='modules/';null!==atscript&&(basepath=atscript.src.replace(/AutoTrimps2\.js$/,''));
